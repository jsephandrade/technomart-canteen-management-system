        ...
        <Card>
          ...
          <CardContent>
            {notifications.length > 0 ? (<div className="space-y-4">
                {notifications.map((notification) => (<div key={notification.id} className={`p-3 rounded-lg flex items-start justify-between ${notification.read ? 'bg-background' : 'bg-muted/40'}`}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.emailNotifications} onCheckedChange={() => handleSettingChange('emailNotifications')}/>
            </div>
            <Separator />
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.pushNotifications} onCheckedChange={() => handleSettingChange('pushNotifications')}/>
            </div>
            <Separator />
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">When inventory is low</p>
              </div>
              <Switch checked={settings.lowStockAlerts} onCheckedChange={() => handleSettingChange('lowStockAlerts')}/>
            </div>
            <Separator />
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">New and updated orders</p>
              </div>
              <Switch checked={settings.orderAlerts} onCheckedChange={() => handleSettingChange('orderAlerts')}/>
            </div>
            <Separator />
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.paymentAlerts} onCheckedChange={() => handleSettingChange('paymentAlerts')}/>
            </div>
          </CardContent>
        </Card>
      </div>
