...
import { OrderItem, QueueOrder, Category, HistoryOrder, Discount } from '@/types/pos';
...
const POS: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'pos' | 'queue')} className="w-full">
