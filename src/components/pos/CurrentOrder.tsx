...
import { ShoppingCart, Plus, Minus, Trash2, CreditCard, Tag, Receipt, X } from 'lucide-react';
import { OrderItem, Discount } from '@/types/pos';

interface CurrentOrderProps {
  currentOrder: OrderItem[];
  discount: Discount;
  onUpdateQuantity: (orderItemId: string, change: 1 | -1) => void;
  onRemoveFromOrder: (orderItemId: string) => void;
  onClearOrder: () => void;
